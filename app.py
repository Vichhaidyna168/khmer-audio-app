...
def get_working_gemini_model_name(selected_name):
    """
    បង្វែរឈ្មោះ Model លើ UI ទៅកាន់ឈ្មោះ API ផ្លូវការរបស់ Google (ដោះស្រាយ Error 404)
    """
...
def on_text_change():
    ...
    st.session_state["srt_input_content"] = st.session_state["srt_text_key"]
...
with tab1:
    ...
    # បង្កើតប្រអប់ Text Area ដោយភ្ជាប់ Key ត្រឹមត្រូវដើម្បីការពារ Auto Clear
    st.text_area(
        "", 
