...
def get_edge_audio_sync(text, voice, out_path):
    """ ទាញយកសំឡេង Edge-TTS ដោយសុវត្ថិភាព មាន gTTS ជាជំនួយ """
...
def generate_synced_audio_km(srt_raw_text, voice_mode_selected):
    ...
    for idx, sub in enumerate(subs):
        ...
        if cleaned_text:
            ...
            success = get_edge_audio_sync(cleaned_text, chosen_voice, audio_path)
