...
def get_tts_audio(text, voice, out_path):
    """ បង្កើតសំឡេងដោយប្រើ edge-tts via CLI ឬ gTTS ដោយធានាថាមិនចោល Error """
    ...
    # ជម្រើសរំលោះ (Fallback) ប្រើ gTTS
    try:
...
def generate_synced_audio_km(srt_raw_text, voice_mode_selected):
    ...
    for idx, sub in enumerate(subs):
        ...
        if cleaned_text:
            ...
            success = get_tts_audio(cleaned_text, chosen_voice, audio_path)
