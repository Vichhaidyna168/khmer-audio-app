...
async def generate_synced_audio(srt_raw_text, voice_mode_selected):
    ...
    for idx, sub in enumerate(subs):
        ...
        # ២. បង្កើតសំឡេង (រាប់បញ្ចូលទាំងអត្ថបទគ្រប់ប្រភេទ ដោយមិនរំលង Time duration)
        if cleaned_text:
            gender = "Male"
    ...
    # ៣. ប្រសិនបើ Time ចុងក្រោយមិនទាន់ដល់ Time បញ្ចប់នៃ SRT ចុងក្រោយ បន្ថែម Silence ឱ្យគ្រប់ ៤ នាទី
...
with st.sidebar:
    ...
    # ចង API Key ជាមួយ query_params ផង និង session_state ផង ដើម្បីឱ្យជាប់រហូតដូចគេ
