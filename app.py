...
# --- Function លុបទិន្នន័យ (លុបប្រអប់ SRT & Audio ជោគជ័យ ១០០%) ---
...
with tab1:
    ...
    # ចងទិន្នន័យ SRT ជាមួយ state ដោយគ្មាន key ប៉ះទង្គិច
    if "srt_text" not in st.session_state:
        st.session_state["srt_text"] = default_srt

    srt_content = st.text_area("", value=st.session_state["srt_text"], height=180)
            ...
            if not active_api_key:
                ...
                with st.spinner(
                    ...
                    try:
                        ...
                        st.session_state["srt_text"] = polished_res
                        st.success(
