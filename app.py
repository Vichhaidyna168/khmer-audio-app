...
# មុខងារ Callback សម្រាប់លុបអត្ថបទ និងសំឡេងដោយសុវត្ថិភាព
default_srt = """1
...
with tab1:
    ...
    # កំណត់តម្លៃដំបូងក្នុង Session State
    ...
    # ប្រើប្រាស់ on_click callback ដើម្បីលុបអត្ថបទ និងសំឡេងដោយគ្មាន Error
    st.button(
