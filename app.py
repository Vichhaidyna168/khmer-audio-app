...
def make_ffmpeg_silence(duration_sec, out_path):
    """ បង្កើត Silence MP3 តាមកម្រិតវិនាទីនៃ Timecode SRT """
...
async def generate_edge_audio_file(text, voice, out_path):
    """ ទាញយកសំឡេង HD ពី Microsoft Edge TTS ហើយ Save ជា File """
...
def generate_synced_audio_km(srt_raw_text, voice_mode_selected):
    ...
    for idx, sub in enumerate(subs):
        ...
        # ជ្រើសរើសសំឡេងតាម Setting ក្នុង Sidebar
    ...
    # ៣. ផ្គុំ MP3 ទាំងអស់ចូលគ្នាដោយប្រើ FFmpeg Concatenate
...
def clear_single_callback():
    """ ប៊ូតុង Clear តែមួយគត់សម្រាប់លុបអត្ថបទ """
