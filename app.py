...
def generate_clean_mp3_silence(duration_sec):
    """ បង្កើត MP3 Silent Frame ស្អាតស្អំសម្រាប់ចន្លោះដកដង្ហើម និងចន្លោះទំនេរតាម Timecode """
    if duration_sec <= 0.02:
        return b""
    # Standard MP3 silent frame (24kHz/32kHz/44.1kHz clean sync)
...
def generate_synced_audio_km(srt_raw_text):
    ...
    for idx, sub in enumerate(subs):
        ...
        # -------------------------------------------------------------
        # 🔑 ប្រព័ន្ធ Sync Timecode & ចង្វាក់ដកដង្ហើមតាម Timecode នៃ SRT
        # -------------------------------------------------------------
