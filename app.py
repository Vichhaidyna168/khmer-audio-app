បាទ/ចាស! ដើម្បីកុំឱ្យអ្នកពិបាករក និងកាត់តកូដជាកំណាត់ៗលើទូរស័ព្ទដៃ ខ្ញុំបានបញ្ចូលកូដថ្មីដែលបានកែសម្រួលរួចជាស្រេច ពេញមួយកូដ (ចាប់ពីដើមរហូតដល់ចប់) ជូនអ្នកនៅខាងក្រោមនេះ។
អ្នកអាចគ្រាន់តែ Copy កូដខាងក្រោមនេះទាំងមូល យកទៅ Paste ជំនួសកូដចាស់នៅក្នុង File app.py របស់អ្នកនៅលើ GitHub ជាការស្រេច៖
import asyncio
import io
import os
import re
