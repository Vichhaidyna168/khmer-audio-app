...
def generate_clean_mp3_silence(duration_sec):
    """ បង្កើត Silence MP3 Frame ស្អាតស្អំ គ្មានសំឡេងរំខាន ឬសំឡេង ង៉ឹតៗ """
    if duration_sec <= 0.02:
        return b""
    # Standard MP3 silent frame (24kHz/32kHz/44.1kHz compatible)
...
async def generate_synced_audio(srt_raw_text, voice_mode_selected, target_lang_selected):
    ...
    for idx, sub in enumerate(valid_subs):
        ...
        # រៀបចំចង្វាក់ដកដង្ហើមតាម Timecode នៃ SRT
